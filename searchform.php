<form role="search" method="get" action="<?php echo home_url() ?>">
    <div class="search-assist-container">
        <input 
            ...
            title="search"
        >
        <button class="submit-button mobile-excluded js-submit-button test-desktop-search-button" type="submit" title="Envía tu pregunta" disabled=""><li-icon class="svg-icon " type="search-icon" size="large" tabindex="-1" aria-hidden="true"><svg viewBox="0 0 24 24" width="24px" height="24px" x="0" y="0" preserveAspectRatio="xMinYMin meet" class="artdeco-icon"><g class="large-icon" style="fill: currentColor">
