...
add_action( 'vc_before_init', 'bs_donate_section_vc' );
  ...
  function bs_donate_section_vc() {
    ...
    $atts = [
      ...
      "text_four_step" => get_option('text_four_step')?:"ACN tiene un mayor impacto cuándo cuenta con la estabilidad proporcionada por la generosidad de sus benefactores.",
      "subtext_four_step" => get_option('subtext_four_step')?:"Podrías ayudarnos con un pequeño valor diario de:",
      "text_footer" => get_option('text_footer')?:"Your donation will be charged to your credit card. You can cancel your contribution anytime you want.",
