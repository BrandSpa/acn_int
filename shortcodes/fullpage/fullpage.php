				...
				<ul>
					<li>
						<a
							...
							target="_blank"
							href="https://www.facebook.com/sharer/sharer.php?u=<?php echo get_the_excerpt(); ?> <?php echo $current_url ?>" >
					...
					<li>
						<a
							class="fullpage__menu__share-icon"
							target="_blank"
							href="https://twitter.com/intent/tweet?text=<?php echo urlencode(get_the_excerpt()) ?>&url=<?php echo $current_url ?>">
