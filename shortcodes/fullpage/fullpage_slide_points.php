...
<svg class="hotspots__world-map" width="1409" height="695" preserveAspectRatio="xMidYMid slice" viewBox="153.6 54 1536 864">
	...
	<g transform="translate(1140, 310)" class="hotspot__pin js-show-pano" data-pano-image="/images/panoramas/aleppo.jpg" data-audio-track="/media/Aleppo-English.mp3" data-pano-yaw="300" data-pano-id="0" ga-on="click" ga-event-category="map" ga-event-action="open" ga-event-label="aleppo-360view" style="opacity: 1; fill-opacity: 1;">
