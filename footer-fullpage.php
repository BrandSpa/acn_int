...
<script
  src="<?php echo get_template_directory_uri() ?>/client/me/vendor_me.js?v=<?php echo filemtime(get_template_directory() . '/client/me/vendor_me.js') ?>"></script>
<script
  src="<?php echo get_template_directory_uri() ?>/client/me/app_me.js?v=<?php echo filemtime(get_template_directory() . '/client/me/app_me.js') ?>"></script>
